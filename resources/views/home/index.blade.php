			...
			<div class="row">
				<div class="col-md-12 text-center">
				  ...
				  <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
					<a href="{{ asset('apps/com.navetteclub.android-1.0.0-2021-02-08.apk') }}" type="button" class="btn btn-green"><i class="fab fa-android"></i>&nbsp;Download APK</a>
					<a href="{{ asset('apps/com.navetteclub.android-1.0.0-2021-02-08.apk') }}" type="button" class="btn btn-green"><i class="fas fa-download"></i></a>
				  </div>
				</div>
			</div>
		</div>
