...
@section('title'){{ __('messages.cars.list') }}@endsection
...
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            ...
            <!--begin::Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{ __('messages.cars.list') }}</h5>
            <!--end::Title-->
                ...
                <div class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded" id="kt_datatable" style=""><table class="datatable-table" style="display: block;">
                    <thead class="datatable-head">
                        <tr class="datatable-row" style="left: 0px;">
                            ...
                            <th data-field="{{ __('messages.drivers') }}" class="datatable-cell datatable-cell-sort"><span style="width: 200px;">{{ __('messages.drivers') }}</span></th>
                            ...
                            <th data-field="{{ __('messages.place') }}" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">{{ __('messages.place') }}</span></th>
                            <th data-field="{{ __('messages.actions') }}" data-autohide-disabled="false" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">{{ __('messages.actions') }}</span></th>
                        </tr>
                    </thead>
                    <tbody class="datatable-body" style="">
                        ...
                        <tr data-row="0" class="datatable-row datatable-row-hover" style="left: 0px;">
                            ...
                            <td data-field="{{ __('messages.cars') }}" aria-label="Czech Republic" class="datatable-cell">
                                <span style="width: 200px;">    
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-dark-75 font-weight-bolder font-size-lg mb-0"><a href="{{ route('admin.car.show', $model) }}">{{ $model->name }}</a></div>
                                            <a href="{{ route('admin.car.show', $model) }}" class="text-muted font-weight-bold text-hover-primary">{{ $model->model ? $model->model->name : '' }}</a>
                                        </div>
                                    </div>
                                </span>
                            </td>
                            <td data-field="{{ __('messages.drivers') }}" aria-label="Czech Republic" class="datatable-cell">
                                <span style="width: 200px;">
                                    @if($model->driver)
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-40 symbol-light-success flex-shrink-0">
                            ...
                            <td data-field="{{ __('Actions') }}" data-autohide-disabled="false" aria-label="null" class="datatable-cell">
                                <span style="overflow: visible; position: relative; width: 100px;">	                        
                                    <a href="{{ route('admin.car.edit', $model)}}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="{{ __('messages.button.edit') }}">
