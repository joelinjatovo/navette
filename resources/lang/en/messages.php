...
return [
    ...
    'form' => [
        ...
        'car' => [
            'create' => 'Ajouter voiture',
            'club' => 'Club',
            'edit' => 'Modifier voiture',
            'image' => 'Image',
            'status' => 'Etat de la voiture',
            'name' => 'Numéro de plaque',
            'type' => 'Type',
            'model' => 'Model',
            'driver' => 'Chauffeur',
            'place' => 'Nombre de place',
            'select_club' => 'Selectionnez club',
            'select_model' => 'Selectionnez model',
            'select_driver' => 'Selectionnez le chauffeur',
            'view' => 'Voir le car',
            'year' => 'Année',
        ],
        'club' => [
            ...
            'image' => 'Club Image',
            'name' => 'Club Name',
            'max_car_place' => 'Nbre max de place de commande',
