...
class CarSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('cars')->insert(['id' => 1, 'name' => 'Economics', 'year' => '2020', 'place' => 5, 'car_model_id' => 1, 'driver_id' => 1, 'user_id' => 1, 'club_id' => 1, 'created_at' => now()]);
        DB::table('cars')->insert(['id' => 2, 'name' => 'Moyen', 'year' => '2020', 'place' => 9, 'car_model_id' => 3, 'driver_id' => 2, 'user_id' => 1, 'club_id' => 1, 'created_at' => now()]);
        DB::table('cars')->insert(['id' => 3, 'name' => 'Van', 'year' => '2020', 'place' => 18, 'car_model_id' => 4, 'driver_id' => 3, 'user_id' => 1, 'club_id' => 1, 'created_at' => now()]);
        DB::table('cars')->insert(['id' => 4, 'name' => 'Van XXL', 'year' => '2020', 'place' => 32, 'car_model_id' => 5, 'driver_id' => 4, 'user_id' => 1, 'club_id' => 1, 'created_at' => now()]);
